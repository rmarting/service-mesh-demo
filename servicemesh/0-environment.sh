...
# Kiali
export KIALI_VERSION=v0.20.0
export KIALI_OPERATOR_NAMESPACE="kiali-operator"
export KIALI_NAMESPACE="kiali"
...
# Microservices
export MSA_PROJECT_NAME="coolstore-ng"
